...
class Q3ViewController: UIViewController {
	...
	let question = "What behavior identifies you best at work?"
	let answers = [
		"You carefully plan ahead and like things to be organized",
		"Working hard is okay, as long as you can play hard as well",
		"You like interactive workspace where everyone can be heard"
	]
	...
	override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
		if let vc = segue.destination as? Q4ViewController {
