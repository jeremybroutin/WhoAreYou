...
class Q5ViewController: UIViewController {
	...
	let question = "The world is coming to an end tomorrow, what do you do?"
	let answers = [
		"You regroup with the persons you love the most",
		"You call Batman to save the world yet again",
		"You arrange a space travel to Mars with your NASA friend"
	]
	...
	@IBAction func nextTapped(_ sender: UIButton) {
		performSegue(withIdentifier: SegueIDs.Result.rawValue, sender: sender)
	}
