...
class Q4ViewController: UIViewController {
	...
	let question = "Back at school, you were..."
	let answers = [
		"Kind of hiding to avoid the teacher's question",
		"A pretty smart ass, not always liked by others",
		"Mostly gossiping instead of listening"
	]
	...
	override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
		if let vc = segue.destination as? Q5ViewController {
